...
class DetailsActivity :
	...
	private fun onMangaUpdated(details: MangaDetails) {
		...
		val isRestricted = details.isRestricted
		with(viewBinding) {
			textViewTitle.text = manga.title
			textViewSubtitle.textAndVisible = manga.altTitles.joinToString("\n")
			textViewNsfw16.isVisible = !isRestricted && manga.contentRating == ContentRating.SUGGESTIVE
			textViewNsfw18.isVisible = !isRestricted && manga.contentRating == ContentRating.ADULT
