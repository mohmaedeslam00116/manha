	...
	class Factory @Inject constructor(
		...
		fun create(source: MangaSource): MangaRepository {
			when (source) {
				...
				LocalMangaSource -> return BlockedContentRepository(localMangaRepository, blockedContentPolicy)
			...
			return synchronized(cache) {
				...
				if (repository != null) {
					BlockedContentRepository(repository, blockedContentPolicy).also {
