...
import org.koitharu.kotatsu.core.content.BlockedContentCleanup
...
open class BaseApp : Application(), Configuration.Provider {
	...
	@Inject
	lateinit var blockedContentCleanup: BlockedContentCleanup
	...
	override fun onCreate() {
		...
		processLifecycleScope.launch(Dispatchers.Default) {
			runCatching {
				blockedContentCleanup.runIfNeeded()
			}.onFailure {
